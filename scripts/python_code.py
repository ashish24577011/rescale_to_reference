...
# Load frequency and reference data
...
# Find the reference length with highest normalized frequency
...
# Calculate required line counts for each length
required_lines = {
...
# Extract lines from merged file
extracted_lines = []
